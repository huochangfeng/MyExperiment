...
public class ChapterDao extends AbstractDao<Chapter, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Progress = new Property(2, String.class, "progress", false, "PROGRESS");
    };
    ...
    public Chapter readEntity(Cursor cursor, int offset) {
        Chapter entity = new Chapter( //
            ...
            cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2) // progress
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Chapter entity, int offset) {
        ...
        entity.setProgress(cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2));
     }
