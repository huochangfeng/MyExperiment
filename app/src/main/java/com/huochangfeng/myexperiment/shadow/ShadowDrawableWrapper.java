...
class ShadowDrawableWrapper extends DrawableWrapper {
    ...
    public ShadowDrawableWrapper(Context context, Drawable content, float radius,
        ...
        mShadowStartColor = ContextCompat.getColor(context, com.huochangfeng.myexperiment.R.color.shadow_1);
        mShadowMiddleColor = ContextCompat.getColor(context, com.huochangfeng.myexperiment.R.color.shadow_2);
        mShadowEndColor = ContextCompat.getColor(context, com.huochangfeng.myexperiment.R.color.shadow_3);
